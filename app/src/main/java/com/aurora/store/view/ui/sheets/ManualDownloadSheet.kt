...
class ManualDownloadSheet : BaseDialogSheet<SheetManualDownloadBinding>() {
    ...
    private fun inflateData() {
        ...
        binding.txtLine3.text = getString(R.string.sheet_manual_download_line3, args.app.versionName, args.app.versionCode)
        binding.versionCodeLayout.hint = getString(R.string.sheet_manual_download_versionCode_hint, args.app.versionCode)
        binding.versionCodeLayout.editText?.setText(getString(R.string.sheet_manual_download_versionCode_hint, args.app.versionCode))
    }
