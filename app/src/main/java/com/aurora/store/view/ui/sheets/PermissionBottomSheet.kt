...
class PermissionBottomSheet : BaseDialogSheet<SheetPermissionsBinding>() {
    ...
    private fun getFakePermissionGroupInfo(packageName: String): PermissionGroupInfo {
        return when (packageName) {
            ...
            "com.google.android.gsf", "com.android.vending" -> PermissionGroupInfo("google", R.drawable.ic_permission_google)
            "com.huawei.hwid", "com.huawei.appmarket" -> PermissionGroupInfo("google", R.drawable.ic_permission_huawei)
