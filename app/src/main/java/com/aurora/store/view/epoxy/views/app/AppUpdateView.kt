        ...
        with(update) {
            ...
            binding.headerIndicator.setOnClickListener {
                if (binding.cardChangelog.isVisible) {
                    binding.headerIndicator.icon = ContextCompat.getDrawable(context, R.drawable.ic_arrow_down)
                    binding.cardChangelog.visibility = View.GONE
                } else {
                    binding.headerIndicator.icon = ContextCompat.getDrawable(context, R.drawable.ic_arrow_up)
