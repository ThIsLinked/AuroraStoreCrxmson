...
class AppInstaller @Inject constructor(
    ...
    companion object {
        ...
        fun notifyInstallation(context: Context, displayName: String, packageName: String) {
            ...
            val notification =
                NotificationUtil.getInstallNotification(context, displayName, packageName)
        ...
        fun hasAppManager(context: Context): Boolean {
            ...
            ) or PackageUtil.isInstalled(context, AMInstaller.AM_DEBUG_PACKAGE_NAME)
        }
    ...
    fun getPreferredInstaller(): IInstaller {
        return when (getCurrentInstaller(context)) {
            ...
            Installer.ROOT -> if (hasRootAccess()) {
                rootInstaller
            } else {
                defaultInstaller
            }
            ...
            Installer.AM -> if (hasAppManager(context)) {
                amInstaller
            } else {
                defaultInstaller
            }
