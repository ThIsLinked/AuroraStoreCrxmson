...
class NativeGsfVersionProvider(context: Context, isExport: Boolean = false) {
    private val googleServicesPackageId = "com.google.android.gms"
    private val googleVendingPackageId = "com.android.vending"
    ...
    init {
        try {
            if (isExport) {
                getPackageInfo(context, googleServicesPackageId).let {
