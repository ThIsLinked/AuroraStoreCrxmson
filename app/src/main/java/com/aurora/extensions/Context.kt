...
fun Context.accentColor(): Int {
    val color = when (Preferences.getInteger(this, Preferences.PREFERENCE_THEME_ACCENT)) {
        ...
        4 -> R.color.colorAccent_4
        5 -> R.color.colorAccent_5
        6 -> R.color.colorAccent_6
        7 -> R.color.colorAccent_7
        8 -> R.color.colorAccent_8
        9 -> R.color.colorAccent_9
        10 -> R.color.colorAccent_10
        11 -> R.color.colorAccent_11
        12 -> R.color.colorAccent_12
        13 -> R.color.colorAccent_13
        14 -> R.color.colorAccent_14
        15 -> R.color.colorAccent_15
