...
object Constants {
    ...
    const val PARCEL_DOWNLOAD: String = "PARCEL_DOWNLOAD"

    const val APP_ID: String = "com.aurora.store"
    ...
    const val NOTIFICATION_CHANNEL_UPDATES: String = "NOTIFICATION_CHANNEL_UPDATES"
    const val NOTIFICATION_CHANNEL_UPDATER_SERVICE: String = "NOTIFICATION_CHANNEL_UPDATER_SERVICE"

    const val GITLAB_URL: String = "https://gitlab.com/AuroraOSS/AuroraStore"
    const val URL_DISPENSER: String = "https://auroraoss.com/api/auth"
    //const val URL_DISPENSER_APPLOUNGE = "https://eu.gtoken.ecloud.global"
